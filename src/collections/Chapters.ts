...
export const Chapters: CollectionConfig = {
  ...
  admin: {
    ...
    livePreview: {
      url: async ({ data, req }) => {
        ...
        const subject = await req.payload.findByID({ collection: 'subjects', id: String(subjectID), req })
  ...
  fields: [
    ...
    { name: 'subject', type: 'relationship', relationTo: 'subjects', index: true, required: true },
