...
export const Lessons: CollectionConfig = {
  ...
  hooks: {
    beforeChange: [
      ({ data }) => {
        if (data.content) data.readingTime = readingTime(data.content as LexicalContent)
        return data
      },
    ],
  },
  ...
  fields: [
    ...
    { name: 'chapter', type: 'relationship', relationTo: 'chapters', index: true, required: true },
